  ...
  return (
    <div>
      <Section id="aboutme" className={`pageBG ${themeClass}`}>
        <SectionColumn
          className={`w-full items-center ml-20 mt-20 sub-head  ${themeClass}`}
        >
          Check out my resume
        </SectionColumn>
        <SectionColumn
          className={`w-full items-center ml-20  main-head  ${themeClass}`}
        >
          Resume
        </SectionColumn>
        <SectionColumn className="w-6/12 md:w-full md:ml-20  items-center mt-4">
          ...
          <Fade bottom>
            <SectionColumn className="w-full items-center ">
              <span className={`resume-heder ${themeClass} mt-10`}>
                Bachelor of science
              </span>
              <span className={`resume-subheder ${themeClass}`}>
                University of Peradeniya
              </span>
              <span className={`resume-p ${themeClass}`}>
                (Computer science,Statistic)
              </span>
            </SectionColumn>
          </Fade>
          <Fade bottom>
            <SectionColumn className="w-full items-center ">
              ...
              <span className={`resume-subheder ${themeClass}`}>
                British Way English Academy(Colombo)
              </span>
            </SectionColumn>
          </Fade>
          <Fade bottom>
            <SectionColumn className="w-full items-center ">
              <span className={`resume-heder ${themeClass} mt-10`}>
                Balangoda Ananda Maithreya
              </span>
              <span className={`resume-heder ${themeClass}`}>
                Central College
              </span>
              <span className={`resume-subheder ${themeClass}`}>
                Pass - Advanced level
              ...
              <span className={`resume-p ${themeClass}`}>
                Physics- B, Chemistry- B, C.Maths-C
              </span>
              <span className={`resume-subheder ${themeClass}`}>
                Pass - Ordinary level
              </span>
